...
#
#     PHX_SERVER=true bin/tire_dispatch start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :tire_dispatch, TireDispatchWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :tire_dispatch, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")
  ...
  config :tire_dispatch, :twilio,
    ...
    phone_number: System.fetch_env!("TWILIO_PHONE_NUMBER")
